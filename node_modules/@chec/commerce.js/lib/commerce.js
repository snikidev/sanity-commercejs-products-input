var Commerce = (function () {
  ...
  var Cart=function(){function a(b){classCallCheck(this,a),this.commerce=b,this.cartId=null;}return createClass(a,[{key:"refresh",value:function refresh(){var a=this;return this.commerce.request("carts").then(function(b){var c=b.id;return a.commerce.storage.set("commercejs_cart_id",c,30),a.cartId=c,b})}},{key:"id",value:function id(){if(null!==this.cartId)return this.cartId;var a=this.commerce.storage.get("commercejs_cart_id");return "string"==typeof a&&a.length?a:null}},{key:"request",value:function(){var a=asyncToGenerator(regenerator.mark(function a(){var b,c,d,e,f,g=this,h=arguments;return regenerator.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:if(b=0<h.length&&void 0!==h[0]?h[0]:"",c=1<h.length&&void 0!==h[1]?h[1]:"get",d=2<h.length&&void 0!==h[2]?h[2]:null,e=!!(3<h.length&&void 0!==h[3])&&h[3],f="string"==typeof b&&b.length?"/".concat(b):"",this.id()){a.next=8;break}return a.next=8,this.refresh();case 8:return a.abrupt("return",this.commerce.request("carts/".concat(this.id()).concat(f),c,d,e).catch(function(a){if(a.statusCode&&404===a.statusCode)return g.refresh().then(function(){return g.commerce.request("carts/".concat(g.id()).concat(f),c,d,e)});throw a}));case 9:case"end":return a.stop();}},a,this)}));return function request(){return a.apply(this,arguments)}}()},{key:"add",value:function add(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:1,c=2<arguments.length&&void 0!==arguments[2]?arguments[2]:null,d={id:"object"===_typeof_1(a)?a.id:a,quantity:b,variant:c};return this.request("","post",d)}},{key:"retrieve",value:function retrieve(){var a=this,b=0<arguments.length&&void 0!==arguments[0]?arguments[0]:null;return b&&(this.cartId=b),this.request().then(function(b){return a.cartId=b&&b.id||null,b})}},{key:"remove",value:function remove(a){return this.request("items/".concat(a),"delete")}},{key:"delete",value:function _delete(){return this.request("","delete")}},{key:"update",value:function update(a,b){return this.request("items/".concat(a),"put",b)}},{key:"contents",value:function contents(){return this.request("items")}},{key:"empty",value:function empty(){return this.request("items","delete")}}]),a}();

  var Categories=function(){function a(b){classCallCheck(this,a),this.commerce=b;}return createClass(a,[{key:"list",value:function list(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:null;return "function"==typeof a?this.commerce.request("categories"):this.commerce.request("categories","get",a)}},{key:"retrieve",value:function retrieve(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};return this.commerce.request("categories/".concat(a),"get",b)}}]),a}();

  var Checkout=function(){function Checkout(a){classCallCheck(this,Checkout),this.commerce=a;}return createClass(Checkout,[{key:"protect",value:function protect(token){return this.commerce.request("checkouts/".concat(token,"/protect")).then(function(data){return eval(data.sift_js)})}},{key:"generateToken",value:function generateToken(a,b){return this.commerce.request("checkouts/".concat(a),"get",b)}},{key:"generateTokenFrom",value:function generateTokenFrom(a,b){if(!["product_id","cart","permalink"].includes(a))throw new Error("Cannot generate a token with unknown \"".concat(a,"\" type"));return this.generateToken(b,{type:a})}},{key:"capture",value:function capture(a,b){var c=this;return this.commerce.request("checkouts/".concat(a),"post",b).then(function(a){return c.commerce.cart.refresh(),a})}},{key:"receipt",value:function receipt(a){return this.commerce.request("checkouts/".concat(a,"/receipt"))}},{key:"checkPayWhatYouWant",value:function checkPayWhatYouWant(a,b){return this.commerce.request("checkouts/".concat(a,"/check/pay_what_you_want"),"get",b)}},{key:"fields",value:function fields(a){return this.commerce.request("checkouts/".concat(a,"/fields"))}},{key:"setTaxZone",value:function setTaxZone(a,b){return this.commerce.request("checkouts/".concat(a,"/helper/set_tax_zone"),"get",b)}},{key:"getLocationFromIP",value:function getLocationFromIP(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"",c=b.length?"?ip_address=".concat(b):"";return this.commerce.request("checkouts/".concat(a,"/helper/location_from_ip").concat(c))}},{key:"isFree",value:function isFree(a){return this.commerce.request("checkouts/".concat(a,"/check/is_free"))}},{key:"checkVariant",value:function checkVariant(a,b,c){return this.commerce.request("checkouts/".concat(a,"/check/").concat(b,"/variant"),"get",c)}},{key:"checkDiscount",value:function checkDiscount(a,b){return this.commerce.request("checkouts/".concat(a,"/check/discount"),"get",b)}},{key:"checkShippingOption",value:function checkShippingOption(a,b){return this.commerce.request("checkouts/".concat(a,"/check/shipping"),"get",b)}},{key:"getShippingOptions",value:function getShippingOptions(a,b){return this.commerce.request("checkouts/".concat(a,"/helper/shipping_options"),"get",b)}},{key:"checkQuantity",value:function checkQuantity(a,b,c){return this.commerce.request("checkouts/".concat(a,"/check/").concat(b,"/quantity"),"get",c)}},{key:"helperValidation",value:function helperValidation(a){return this.commerce.request("checkouts/".concat(a,"/helper/validation"))}},{key:"getLive",value:function getLive(a){return this.commerce.request("checkouts/".concat(a,"/live"))}},{key:"getToken",value:function getToken(a){return this.commerce.request("checkouts/tokens/".concat(a))}},{key:"checkGiftcard",value:function checkGiftcard(a,b){return this.commerce.request("checkouts/".concat(a,"/check/giftcard"),"get",b)}}]),Checkout}();
  ...
  var Products=function(){function a(b){classCallCheck(this,a),this.commerce=b;}return createClass(a,[{key:"list",value:function list(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:null;return this.commerce.request("products","get",a)}},{key:"retrieve",value:function retrieve(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};return this.commerce.request("products/".concat(a),"get",b)}}]),a}();
