...
import { responsivePaddingStyle } from '../../styles';
...
const DialogCard = forwardRef((props, ref) => {
    const { cardRadius, cardShadow, children, contentRef, footer, header, id, onClose, scheme, width, } = props;
    ...
    return (React.createElement(DialogContainer, { width: width },
        React.createElement(DialogCardRoot, { radius: cardRadius, ref: setRef, scheme: scheme, shadow: cardShadow },
...
export const Dialog = forwardRef((props, ref) => {
    ...
    return (React.createElement(Portal, null,
        React.createElement(Root, Object.assign({}, restProps, { "aria-labelledby": labelId, "aria-modal": true, id: id, onFocus: handleFocus, padding: padding, position: position, ref: ref, role: "dialog" }),
            React.createElement("div", { ref: preDivRef, tabIndex: 0 }),
            React.createElement(DialogCard, { cardRadius: cardRadius, cardShadow: cardShadow, contentRef: contentRef, footer: footer, header: header, id: id, onClose: onClose, ref: cardRef, scheme: scheme, width: width }, children),
